      ...
      <div className="space-y-12">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed prose prose-lg max-w-none">
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">A Tragedy Written in Concrete</h3>
            <p>
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">From Grief to Resolve: Can Paddlefish Rise Again?</h3>
            <p>
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">Roadmap for Revival: A Call to Action</h3>
            <h4 className="font-headline text-xl text-primary !mt-6 !mb-2">Genetic Preservation and Research</h4>
            <p>
            ...
            <h4 className="font-headline text-xl text-primary !mt-6 !mb-2">Restoration of River Connectivity</h4>
            <p>
            ...
            <h4 className="font-headline text-xl text-primary !mt-6 !mb-2">Public Engagement and National Pride</h4>
            <p>
            ...
            <h4 className="font-headline text-xl text-primary !mt-6 !mb-2">Explore Emerging Technologies</h4>
            <p>
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">Conclusion: Memory as Mandate</h3>
            <p>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="font-headline text-3xl text-primary">A Second Dawn for the River's King: Can a Lost Giant Swim Again?</CardTitle>
            <p className="text-sm text-muted-foreground">Shanghai, China – August 4, 2025</p>
          </CardHeader>
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed prose prose-lg max-w-none">
            <p>
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">A Roadmap for Resurrection: From Memory to Matter</h3>
            <p>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li><strong>The Genetic Blueprint:</strong> The foundation of any de-extinction project is the complete genome of the extinct species. Fortunately, tissue samples of the Chinese paddlefish are preserved in scientific institutions. The first step is to fully sequence and map the complete DNA of Psephurus gladius, creating the digital blueprint for its revival.</li>
              <li><strong>The Living Surrogate:</strong> A closely related living species is needed to serve as the genetic template and eventual surrogate mother. The paddlefish family has one other living member: the American paddlefish (Polyodon spathula). This surviving cousin, which inhabits the Mississippi River basin, is the indispensable key. Its genome would serve as the chassis upon which the Chinese paddlefish's genetic code is rebuilt.</li>
              <li><strong>The Engineering of Life:</strong> Using CRISPR or similar gene-editing tools, scientists would meticulously alter the DNA within the embryo of an American paddlefish. The goal would be to edit the genetic markers that differentiate the American species from the Chinese one, effectively "translating" the DNA until it matches the blueprint of Psephurus gladius.</li>
              <li><strong>From Embryo to Organism:</strong> This genetically-edited embryo would then need to be implanted into a female American paddlefish to be carried to term. The successful birth of a healthy, living Chinese paddlefish would be a landmark scientific achievement, but it would only be the beginning of the journey.</li>
              <li><strong>Healing the River:</strong> The most crucial and challenging step has little to do with genetics and everything to do with its original home. A resurrected paddlefish cannot survive in a broken river. Resurrecting the species without restoring its habitat would be a hollow, cruel victory. This requires a national-level commitment to:
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>Restoring Migration Routes: Constructing advanced fish ladders, elevators, or bypass channels around the Gezhouba and Three Gorges dams to create a viable, continuous upstream path for migration.</li>
                  <li>Rehabilitating Spawning Grounds: Identifying and restoring the historic upstream spawning areas, ensuring they are free from pollution and have the appropriate gravel substrate and water flow.</li>
                  <li>Ensuring Absolute Protection: Enacting and enforcing a permanent, zero-tolerance policy on catching the species, coupled with robust public education campaigns to foster national pride and a sense of guardianship.</li>
                </ul>
              </li>
            </ol>
            <p>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="font-headline text-3xl text-primary">From Silence to Resurrection: A Vision for Reviving the Chinese Paddlefish</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed prose prose-lg max-w-none">
            <p>
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">⚖️ Mourning the Paddlefish</h3>
            <p>
            ...
            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">🌱 A Roadmap to Revival</h3>
            <p>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li><strong>Genomic Preservation</strong>
                <ul className="list-disc pl-6 mt-1">
                  <li>Secure DNA samples from museum specimens or preserved tissues.</li>
                  <li>Sequence the genome to identify traits essential for survival and reproduction.</li>
                </ul>
              </li>
              <li><strong>Synthetic Biology & Cloning</strong>
                <ul className="list-disc pl-6 mt-1">
                  <li>Explore gene-editing technologies to reconstruct paddlefish traits in surrogate species.</li>
                  <li>Investigate hybridization pathways using closely related paddlefish or sturgeon species.</li>
                </ul>
              </li>
              <li><strong>Habitat Restoration</strong>
                <ul className="list-disc pl-6 mt-1">
                  <li>Retrofit fish passages in existing dams to support future anadromous species.</li>
                  <li>Restore spawning grounds with natural sediment and flow regimes.</li>
                </ul>
              </li>
              <li><strong>Policy & Protection</strong>
                <ul className="list-disc pl-6 mt-1">
                  <li>Enforce strict conservation laws for remaining river species.</li>
                  <li>Designate ecological corridors to prevent future fragmentation.</li>
                </ul>
              </li>
              <li><strong>Public Engagement & Cultural Memory</strong>
                <ul className="list-disc pl-6 mt-1">
                  <li>Launch educational campaigns to honor the paddlefish and raise awareness.</li>
                  <li>Collaborate with artists, poets, and historians to embed its story in cultural consciousness.</li>
                </ul>
              </li>
              <li><strong>International Collaboration</strong>
                <ul className="list-disc pl-6 mt-1">
                  <li>Partner with global biotech firms and conservation groups to share expertise and resources.</li>
                  <li>Establish a Yangtze Biodiversity Innovation Hub to coordinate efforts.</li>
                </ul>
              </li>
            </ol>

            <h3 className="font-headline text-2xl text-primary !mt-8 !mb-4">🌊 A Future Worth Imagining</h3>
            <p>
